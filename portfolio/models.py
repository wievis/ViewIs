...
class Media(models.Model):
    MEDIA_TYPES = [('image', 'Image'), ('video', 'Video'), ('model3d', 'Model 3D')]
    file = models.FileField(upload_to='media/')
    album = models.ForeignKey(Album, on_delete=models.SET_NULL, blank=True, null=True, related_name='media_items')
    ...
    def __str__(self): return f"{self.media_type} {self.id}"